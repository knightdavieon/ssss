        ...
        if($count > 0){
          while($rows = mysqli_fetch_array($query)){
            ...
            <tr>
              ...
              <td><a href="Edit_Data_ecleaning.php?uid=<?php echo $rows['unique_id']; ?>" class="btn btn-info"><i class="fa fa-pencil-square-o"></i></a><button type="submit" onclick="return confirm('Confirm Removing of Data');" class="btn btn-danger" name="btn_delete" value="<?php echo $rows['unique_id']?>"><i class="fa fa-remove"></i></button>
                          <input type="hidden" name="phone_number" value="<?php echo $rows[3]; ?>">

    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
               ...
               <form method="post" action="edit_account.php?ecode=<?php echo stripslashes($_GET['ecode']); ?>">
                ...
                <div class="row">
                    <div class="col-md-7 col-sm-12 col-xs-12">
                        <div class="white-box">
                            ...
                            <hr>
                          <?php 
                              $account_query = "Select * from users  where employee_code= '" . $_GET['ecode'] . "'";
                              $account_result = mysqli_query($conn, $account_query);
                              if($account_rows = mysqli_fetch_array($account_result)){


                              
                          ?>
                            <label> Employee Code </label>
                            <input type="text" class="form-control" disabled="disabled" id="ecode" value="<?php echo $account_rows[0]; ?>">
                            <label style="margin-top:10px;"> Name </label>
                            <input type="text" class="form-control" style="text-transform:uppercase;" placeholder="LASTNAME, FIRSTNAME, MIDDLENAME" id="full_name" value="<?php echo $account_rows[1]; ?>">
                            <label style="margin-top:10px;"> User Type </label> || Current : <label style="color:#009900;"> <?php echo $account_rows[5]; ?>  </label>
                            ...
                            <input type="text" class="form-control" id="username" value="<?php echo  $account_rows[2]; ?>">
                            <label style="margin-top:10px;"> Password </label>
                            <input type="password" id="o_password" class="form-control">
                ...
                <div class="col-md-5 col-sm-12 col-xs-12">
                         ...
                         <div class="col-md-offset-4">
                          <label> Current Status</label><br/>
                           ...
                           <?php 
                              	...
                              	if($account_rows[4] == "ACTIVE"){
                              	 ?>
                              	   <label style="color:#009900;"> ACTIVE </label>
                              	 <?php
                              	}else{
                                 ?>
                                  <label style="color:#ff0000;"> DEACTIVE </label>
                                <?php
                              	}
                   ...
                   <?php } ?>
                       <select class="form-control" style="cursor:pointer;" id="account_status">
             ...
             <script> 
                   $('#btn_save').click(function(){
                       var ecode = $('#ecode').val();
                       var account = $('#account_status').val();
                       ...
                       $.ajax({
                           type:"POST",
                           url:"edit_account_query.php",
                           data:{ecode:ecode, full_name:full_name, username:username, o_password:password, user_type:user_type, c_password:confirm_password, account_status:account},
                           success:function(result){
                                if(result == "true"){
                                    alert("Account has been successfully updated");
                                    window.location = "edit_account.php?ecode=" + document.getElementById("ecode").value;
